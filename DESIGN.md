...
- **DB connection budget.** `max_connections = WORKER_POOL_SIZE + READ_POOL_SIZE`. Each worker holds at most one connection; the extra connections (default 4) cover direct-pool reads.
